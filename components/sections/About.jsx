...
export function WhoWeAreSection({ t }) {
  return (
    <section className="py-16 md:py-20 pt-20 md:pt-36 relative overflow-hidden bg-white" data-aos="fade-up">
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-5 items-center">
          {/* Text Content */}
          <div className="order-2 md:order-1 text-center " data-aos="fade-up" data-aos-delay="100">
            <SectionHeader
            ...
            <Image
              ...
              width={519}
              height={519}
              className="hidden md:block absolute top-0 -start-40 w-[400px] h-[400px] object-contain opacity-70"
              priority
            />
            <p className="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed max-w-lg mx-auto md:mx-0">
          ...
          {/* Image Content */}
          <div className="order-1 md:order-2 relative flex justify-center items-center" data-aos="zoom-in" data-aos-delay="150">
        ...
        {/* CTA Button */}
        <div className="flex justify-center mt-10 md:mt-12" data-aos="fade-up" data-aos-delay="200">
